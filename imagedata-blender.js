//
// My inputs are imageData, not CanvasRenderingContext2D, so I can't use CanvasRenderingContext2D.prototype
//
...
if (window.CanvasRenderingContext2D && CanvasRenderingContext2D.prototype.getImageData){
	...
	window.MeemooBlend = function(source,destination,blendMode,offsetOptions){
		var offsets={};
